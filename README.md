...
## Running the program
This project is built using the Unity Engine. To run this program you must install [Unity from their website](https://unity3d.com/get-unity/download). Once installed you can clone this repo onto your local machine and then open the folder you cloned this repo into in Unity. Once the project is opened  you need to open the House scene to display the scene. Select "Open Scene" from the file menu and select the "House Scene.unity" file that is in your assets folder. Finally, select the play button that is located near the center top of your view. This will start the program.
